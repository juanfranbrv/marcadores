  ...
  grid.innerHTML = filtered.map(bm => {
    ...
    return `
      <a href="${bm.url}" target="_blank" class="block group focus:outline-none h-full">
        <div class="bg-white rounded-lg shadow flex flex-col h-full min-h-[420px] max-h-[420px] p-0 transition ring-2 ring-transparent group-hover:ring-blue-200 group-focus:ring-blue-400">
          ...
          <div class="p-4 flex flex-col gap-2 flex-1">
            ...
            <p class="text-sm text-gray-600 line-clamp-3 overflow-hidden" style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">${bm.comment}</p>
